...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        # get out features and up sample
        # out_feature_index = [8]
        # mid_feature = []
        # for idx in out_feature_index: 
        #     mid_feature.append(down_block_res_samples[idx])
        ...
        return UNet2DConditionOutput(sample=sample), out_feature
